...
import static io.cucumber.core.gherkin.vintage.internal.gherkin.Parser.RuleType.Scenario;
...
//        }
    ...
    public static void caancelAlert() {
        Alert alert = driver.switchTo().alert();
        alert.dismiss();
    }

    public static void okkAlert() {
        Alert alert = driver.switchTo().alert();
        alert.accept();
    }
...
//    WebDriver driver
    ...
    public static List<WebElement> getListOfWebElemenntByXpath(String locator) {
        List<WebElement> list = new ArrayList<WebElement>();
